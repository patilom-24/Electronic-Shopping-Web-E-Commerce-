...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "omp93481@outlook.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Patil Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Patil Electronics.<br>"
					...
					+ "<span class='greenText'>Patil500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
